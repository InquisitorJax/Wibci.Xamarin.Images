...
namespace Wibci.Xamarin.Images.UWP
{
	...
	{
		/// <summary>
		/// doc: https://riptutorial.com/uwp/example/29447/crop-and-resize-image-using-bitmap-tool
		...
		public static async Task<WriteableBitmap> GetCroppedBitmapAsync(StorageFile originalImageFile, Point startPoint, Size corpSize, double scale)
		{
			//doc: https://github.com/XamlBrewer/UWP-ImageCropper-/blob/master/XamlBrewer.Uwp.Controls/Helpers/CropBitmap.cs
		...
		//doc: https://github.com/windows-toolkit/WindowsCommunityToolkit/blob/master/Microsoft.Toolkit.Uwp.UI.Controls/ImageCropper/ImageCropper.Helpers.cs
